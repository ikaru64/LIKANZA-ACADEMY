...
const QUIZ_BANK_FULL = [
  ...
  {id:"q-epargne-003", niveau:"intermediaire", categorie:"Épargne", type:"qcm", question:"Quelle est la différence principale entre épargner et investir ?", choix:["Il n'y a aucune différence","Épargner vise la sécurité et la disponibilité, investir vise la croissance avec un risque de perte","Investir est toujours sans risque","Épargner rapporte toujours plus qu'investir"], bonneReponse:1, explication:"L'épargne privilégie la sécurité du capital et sa disponibilité rapide, l'investissement accepte un risque de perte en échange d'un potentiel de rendement supérieur.",
    misconceptions:{3:{id:'securite-vs-performance', label:"Tu confonds sécurité de l'épargne et performance de l'investissement", fix:"C'est l'inverse qui est vrai en moyenne sur le long terme : l'épargne sécurisée protège le capital mais plafonne son rendement, tandis que l'investissement accepte un risque de perte en échange d'un potentiel de gain supérieur — la sécurité et la performance s'échangent, elles ne s'additionnent pas."}}},
  ...
  {id:"q-intsimples-002", niveau:"intermediaire", categorie:"Intérêts simples", type:"calcul", question:"Un capital de 1000€ placé à intérêts simples de 5% par an rapporte combien d'intérêts après 3 ans ?", choix:["50€","150€","157,6€","300€"], bonneReponse:1, explication:"Intérêts simples = capital × taux × durée = 1000 × 0,05 × 3 = 150€.",
    misconceptions:{2:{id:'simples-vs-composes', label:"Tu confonds intérêts simples et intérêts composés", fix:"157,6€ est le résultat en intérêts COMPOSÉS (1000 × 1,05³ − 1000), pas en intérêts simples. En intérêts simples, chaque année rapporte le même montant fixe sur le capital initial : 1000 × 0,05 × 3 = 150€, sans effet boule de neige sur les intérêts déjà versés."}}},
  ...
  {id:"q-intcomposes-003", niveau:"intermediaire", categorie:"Intérêts composés", type:"calcul", question:"Un capital de 1000€ placé à 5% par an en intérêts composés vaut environ combien après 2 ans ?", choix:["1050€","1100€","1102,5€","1150€"], bonneReponse:2, explication:"1000 × 1,05 × 1,05 = 1102,5€. La deuxième année, les intérêts se calculent aussi sur les intérêts de la première année.",
    misconceptions:{1:{id:'composes-vs-simples', label:"Tu confonds intérêts composés et intérêts simples", fix:"1100€ correspond à un calcul en intérêts SIMPLES (1000 + 2×50€). En intérêts composés, la 2e année rapporte aussi des intérêts sur les intérêts de la 1ère année : 1000 × 1,05 × 1,05 = 1102,5€ — un écart faible sur 2 ans, mais qui s'amplifie fortement avec le temps."}}},
  ...
  {id:"q-actions-003", niveau:"intermediaire", categorie:"Actions", type:"qcm", question:"Que peut indiquer un PER (Price Earning Ratio) élevé pour une action ?", choix:["Que l'entreprise est en faillite","Que le marché anticipe une forte croissance, ou que la valorisation est tendue","Que l'action ne verse jamais de dividende","Que l'action est interdite au PEA"], bonneReponse:1, explication:"Un PER élevé peut refléter des attentes de croissance fortes, mais aussi signaler une valorisation exigeante par rapport aux bénéfices actuels.",
    misconceptions:{0:{id:'per-vs-faillite', label:"Tu confonds un PER élevé et un signe de faillite", fix:"Un PER élevé signifie que le marché paie cher chaque euro de bénéfice actuel — souvent parce qu'il anticipe une forte croissance future, ou parce que la valorisation est simplement tendue. Une entreprise en difficulté financière aurait plutôt un PER très bas, voire négatif ou non calculable (bénéfices nuls ou négatifs)."}}},
  ...
  {id:"q-etf-004", niveau:"avance", categorie:"ETF", type:"qcm", question:"Un ETF à effet de levier x2 vise à répliquer un multiple de 2 de la performance de son indice sur quelle période exactement ?", choix:["Sur toute la durée de détention, quelle qu'elle soit", "Sur la seule performance QUOTIDIENNE de l'indice, rebalancée chaque jour", "Sur une période fixe d'un an", "Le multiple ne s'applique qu'à l'échéance du produit"], bonneReponse:1, explication:"Le levier d'un ETF à effet de levier se recalcule chaque jour sur la clôture précédente : il ne vise un multiple exact que de la performance quotidienne, jamais de la performance cumulée sur plusieurs jours ou semaines.",
    misconceptions:{0:{id:'levier-quotidien-vs-cumule', label:"Tu confonds effet de levier quotidien et effet de levier cumulé sur la durée de détention", fix:"Un ETF à effet de levier x2 recalcule son multiple chaque jour, sur la clôture de la veille — il ne vise un x2 exact que sur UNE journée. Sur plusieurs jours de marché volatil, l'effet de la « perte de volatilité » (volatility drag) fait dévier la performance cumulée du simple x2 de l'indice, parfois fortement."}}},
  ...
  {id:"q-obligations-002", niveau:"intermediaire", categorie:"Obligations", type:"qcm", question:"Que se passe-t-il généralement pour le prix d'une obligation existante quand les taux d'intérêt du marché montent ?", choix:["Son prix monte","Son prix baisse","Son prix reste rigoureusement identique","Elle devient automatiquement une action"], bonneReponse:1, explication:"Quand les taux montent, les nouvelles obligations offrent un coupon plus attractif, ce qui fait mécaniquement baisser le prix des obligations existantes à coupon plus faible.",
    misconceptions:{0:{id:'taux-vs-prix-obligation', label:"Tu confonds le sens de la relation entre taux d'intérêt et prix des obligations", fix:"C'est l'inverse : quand les taux du marché montent, les nouvelles obligations émises offrent un coupon plus attractif, ce qui rend les obligations existantes (à coupon plus faible) moins désirables — leur prix baisse mécaniquement pour rester compétitif."}}},
  ...
  {id:"q-analysetech-007", niveau:"avance", categorie:"Analyse technique", type:"qcm", question:"Que représente un croisement haussier du MACD (sa ligne MACD qui passe au-dessus de sa ligne de signal) ?", choix:["Une garantie que le prix va monter dans les jours qui suivent", "Un signal de momentum haussier naissant selon la convention utilisée par certains praticiens, jamais une garantie de mouvement futur", "Le seul indicateur technique fiable à lui seul", "Une preuve que l'entreprise vient de publier de bons résultats"], bonneReponse:1, explication:"Un croisement haussier du MACD est interprété par certains praticiens comme un signal de momentum naissant — une convention parmi d'autres, comme les seuils du RSI ou les bandes de Bollinger, jamais une garantie de mouvement futur."},
  {id:"q-analysetech-008", niveau:"intermediaire", categorie:"Analyse technique", type:"qcm", question:"Pourquoi le volume échangé est-il souvent utilisé pour évaluer la fiabilité d'un mouvement de prix ?", choix:["Le volume n'a aucun rapport avec la fiabilité d'un mouvement de prix", "Un mouvement de prix accompagné d'un volume élevé reflète généralement une conviction plus large du marché qu'un mouvement similaire sur un volume faible", "Un volume élevé garantit que le mouvement de prix va se poursuivre", "Le volume mesure uniquement les frais de transaction payés par les investisseurs"], bonneReponse:1, explication:"Un volume élevé accompagnant un mouvement de prix suggère qu'un grand nombre d'acteurs du marché y participent, ce qui est généralement jugé plus significatif qu'un mouvement similaire causé par quelques transactions isolées sur un volume faible — sans pour autant garantir la suite du mouvement."},
  ...
  {id:"q-options-001", niveau:"intermediaire", categorie:"Options", type:"qcm", question:"Qu'est-ce qu'un call ?", choix:["Une option qui donne le droit de vendre un actif à un prix fixé à l'avance", "Une option qui donne le droit d'acheter un actif à un prix fixé à l'avance", "L'obligation d'acheter une action à son cours actuel", "Un type d'ordre boursier qui garantit un prix d'exécution"], bonneReponse:1, explication:"Un call donne à son acheteur le droit, jamais l'obligation, d'acheter l'actif sous-jacent à un prix d'exercice fixé à l'avance.",
    misconceptions:{0:{id:'call-vs-put', label:"Tu confonds le call et le put", fix:"C'est la définition du PUT que tu décris : le droit de VENDRE à un prix fixé à l'avance. Le call, lui, donne le droit d'ACHETER à ce prix fixé — dans les deux cas un droit, jamais une obligation, ce qui les distingue aussi d'un simple ordre d'achat classique."}}},
  ...
  {id:"q-immobilier-003", niveau:"avance", categorie:"Immobilier", type:"qcm", question:"Qu'est-ce que le cash-flow d'un investissement locatif financé à crédit ?", choix:["Le prix d'achat du bien","La différence entre les loyers encaissés et l'ensemble des charges, crédit inclus","Le montant de l'apport initial","La plus-value latente du bien"], bonneReponse:1, explication:"Le cash-flow mesure ce qu'il reste (ou manque) chaque mois une fois toutes les charges payées, crédit compris : un indicateur clé de la viabilité réelle d'un projet à effet de levier.",
    misconceptions:{3:{id:'cashflow-vs-plusvalue', label:"Tu confonds cash-flow et plus-value latente", fix:"Le cash-flow est une réalité mensuelle immédiate (loyers encaissés moins toutes les charges, crédit inclus) ; la plus-value latente n'est qu'un gain sur le papier, non encaissé, qui dépend de la valeur de revente estimée du bien — un investissement peut avoir une belle plus-value latente tout en générant un cash-flow négatif chaque mois."}}},
  {id:"q-immobilier-004", niveau:"avance", categorie:"Immobilier", type:"qcm", question:"Une résidence secondaire revendue avec plus-value après 25 ans de détention est-elle totalement exonérée d'impôt ?", choix:["Non, la plus-value reste toujours entièrement taxée quelle que soit la durée","Oui pour l'impôt sur le revenu (exonération à 22 ans), mais les prélèvements sociaux restent dus jusqu'à 30 ans de détention","Oui, exonération totale dès 10 ans de détention","Seule la résidence principale bénéficie d'un abattement progressif"], bonneReponse:1, explication:"L'abattement pour durée de détention mène à une exonération d'impôt sur le revenu après 22 ans, mais les prélèvements sociaux ne sont totalement exonérés qu'après 30 ans : deux durées distinctes, à ne pas confondre.",
    misconceptions:{2:{id:'duree-exoneration-plusvalue', label:"Tu confonds les deux durées de détention distinctes (22 ans et 30 ans)", fix:"L'exonération n'est jamais aussi rapide que 10 ans : l'impôt sur le revenu sur la plus-value s'exonère progressivement jusqu'à 22 ans de détention, mais les prélèvements sociaux suivent un calendrier différent et ne s'exonèrent totalement qu'à 30 ans — deux seuils à ne pas confondre."}}},
  ...
  {id:"q-credit-003", niveau:"intermediaire", categorie:"Crédit", type:"qcm", question:"Qu'est-ce que l'assurance emprunteur associée à un crédit immobilier ?", choix:["Une assurance sur la valeur de revente du bien","Une assurance qui prend en charge le remboursement en cas d'événements comme le décès ou l'invalidité","Une garantie de taux fixe à vie","Un impôt local obligatoire"], bonneReponse:1, explication:"L'assurance emprunteur protège la banque (et l'emprunteur) en cas de décès, invalidité ou incapacité, en prenant en charge tout ou partie du remboursement.",
    misconceptions:{0:{id:'assurance-emprunteur-vs-bien', label:"Tu confonds assurance emprunteur et assurance sur la valeur du bien", fix:"L'assurance emprunteur ne protège pas la valeur de revente du logement : elle prend en charge le remboursement du crédit en cas d'événements touchant l'emprunteur lui-même (décès, invalidité, incapacité) — une assurance sur les personnes, pas sur le bien."}}},
  ...
  {id:"q-fiscalite-001", niveau:"intermediaire", categorie:"Fiscalité de base", type:"qcm", question:"Que désigne le terme \"plus-value\" en matière d'investissement ?", choix:["Le montant initial investi","Le gain réalisé entre le prix d'achat et le prix de vente d'un actif","Un type d'impôt sur le revenu du travail","Un synonyme de dividende"], bonneReponse:1, explication:"La plus-value correspond à la différence positive entre le prix de vente et le prix d'achat d'un actif ; elle est généralement soumise à une fiscalité spécifique.",
    misconceptions:{3:{id:'plus-value-vs-dividende', label:"Tu confonds plus-value et dividende", fix:"Ce sont deux gains de nature différente : la plus-value est le gain réalisé en revendant un actif plus cher qu'il n'a été acheté, le dividende est une part des bénéfices qu'une entreprise choisit de reverser à ses actionnaires sans qu'il y ait de vente. Les deux ont d'ailleurs souvent une fiscalité distincte."}}},
  ...
  {id:"q-crypto-blockchain-003", niveau:"intermediaire", categorie:"Blockchain", type:"qcm", question:"Quelle est la différence principale entre la preuve de travail (Proof of Work) et la preuve d'enjeu (Proof of Stake) ?", choix:["Il n'y a aucune différence, ce sont des synonymes", "La preuve de travail valide les blocs par un calcul informatique coûteux, la preuve d'enjeu par le blocage de cryptoactifs en garantie", "La preuve d'enjeu n'existe que pour les monnaies fiduciaires", "La preuve de travail est toujours plus rapide"], bonneReponse:1, explication:"La preuve de travail (ex. Bitcoin) demande une puissance de calcul importante pour valider un bloc. La preuve d'enjeu (ex. Ethereum depuis 2022) demande aux validateurs de bloquer des cryptoactifs en garantie, avec une consommation énergétique bien plus faible.",
    misconceptions:{0:{id:'pow-vs-pos', label:"Tu confonds preuve de travail (Proof of Work) et preuve d'enjeu (Proof of Stake)", fix:"Ce ne sont pas deux noms pour le même mécanisme : la preuve de travail valide les blocs via un calcul informatique coûteux en énergie, la preuve d'enjeu via le blocage de cryptoactifs en garantie par les validateurs — un fonctionnement, une consommation énergétique et des acteurs différents."}}},
  ...
  {id:"q-crypto-tokenomics-002", niveau:"debutant", categorie:"Tokenomics", type:"qcm", question:"Que signifie un \"supply maximum\" plafonné, comme les 21 millions de bitcoins ?", choix:["Le nombre de bitcoins qui seront émis chaque année", "Le nombre total d'unités qui pourront exister au maximum, jamais dépassé", "Le nombre de bitcoins actuellement en circulation", "Le prix maximum autorisé par unité"], bonneReponse:1, explication:"Le supply maximum est un plafond théorique définitif inscrit dans le protocole — le nombre d'unités en circulation à un instant donné (supply circulant) peut lui rester inférieur pendant des décennies.",
    misconceptions:{2:{id:'supply-max-vs-circulant', label:"Tu confonds offre maximum et offre en circulation", fix:"L'offre en circulation, c'est ce qui existe déjà et s'échange aujourd'hui sur le marché. L'offre maximum (21 millions pour le bitcoin) est un plafond théorique définitif inscrit dans le protocole, qui peut mettre des décennies à être entièrement atteint — les deux chiffres peuvent être très différents pendant longtemps."}}},
  {id:"q-crypto-tokenomics-003", niveau:"intermediaire", categorie:"Tokenomics", type:"qcm", question:"Pourquoi un prix unitaire très bas ne signifie-t-il pas qu'un token est \"bon marché\" ?", choix:["Un prix bas garantit toujours une hausse future", "Le prix unitaire dépend aussi du nombre total de tokens en circulation (capitalisation = prix × offre en circulation)", "Le prix unitaire n'a jamais d'importance", "Les tokens à prix bas sont toujours des arnaques"], bonneReponse:1, explication:"Un token à 0,001€ avec 1000 milliards d'unités en circulation peut avoir une capitalisation bien supérieure à un token à 500€ avec peu d'unités : le prix unitaire seul ne dit rien de la valorisation réelle.",
    misconceptions:{0:{id:'prix-unitaire-vs-capitalisation', label:"Tu confonds prix unitaire bas et capitalisation faible", fix:"Un prix bas ne garantit rien sur l'avenir, et surtout, il ne dit rien seul de la valorisation réelle : la capitalisation se calcule en multipliant le prix par le nombre d'unités en circulation. Un token à 0,001€ avec 1000 milliards d'unités peut valoir bien plus, au total, qu'un token à 500€ avec peu d'unités en circulation."}}},
  ...
  {id:"q-crypto-defi-004", niveau:"avance", categorie:"DeFi", type:"qcm", question:"Qu'est-ce que la \"perte impermanente\" (impermanent loss) pour un fournisseur de liquidité ?", choix:["Une perte garantie et systématique dans tous les cas", "Un manque à gagner qui apparaît quand le prix des actifs déposés évolue différemment de celui au moment du dépôt, comparé au fait de simplement les avoir gardés", "Des frais de transaction fixes", "Un bug rendant les fonds définitivement inaccessibles"], bonneReponse:1, explication:"Si les prix relatifs des deux actifs d'une pool divergent après le dépôt, la valeur récupérée en retirant ses fonds peut être inférieure à celle obtenue en ayant simplement conservé les actifs sans les déposer — un risque spécifique à la fourniture de liquidité, distinct du risque de marché classique.",
    misconceptions:{3:{id:'perte-impermanente-vs-bug', label:"Tu confonds perte impermanente et bug/piratage", fix:"La perte impermanente n'a rien d'un bug qui bloquerait définitivement les fonds : c'est un manque à gagner qui apparaît quand les prix des actifs déposés évoluent différemment entre eux après le dépôt, comparé au fait de simplement les avoir conservés — un risque économique du mécanisme, pas une défaillance technique."}}},
  ...
  {id:"q-crypto-securite-003", niveau:"intermediaire", categorie:"Sécurité crypto", type:"qcm", question:"Que signifie l'expression \"Not your keys, not your coins\" ?", choix:["Les clés privées n'ont aucune importance pratique", "Si tu ne détiens pas toi-même les clés privées (ex. fonds laissés sur une plateforme), tu ne contrôles pas réellement tes cryptoactifs", "Seules les banques peuvent détenir des clés privées", "C'est un slogan publicitaire sans fondement technique"], bonneReponse:1, explication:"Laisser ses fonds sur une plateforme d'échange revient à faire confiance à cette plateforme pour la garde de tes actifs : en cas de faillite, de piratage ou de blocage des retraits, tu dépends entièrement d'elle — d'où l'importance, pour qui le souhaite, de gérer soi-même ses clés.",
    misconceptions:{0:{id:'custodial-risk', label:"Tu sous-estimes le risque de garde (custodial risk) sur une plateforme", fix:"Les clés privées ont une importance très concrète : laisser ses fonds sur une plateforme d'échange revient à lui faire confiance pour leur garde. En cas de faillite, de piratage ou de blocage des retraits par la plateforme, tu ne contrôles plus réellement tes cryptoactifs tant que tu ne détiens pas toi-même les clés."}}},
  ...
  {id:"q-patrimoine-006", niveau:"avance", categorie:"Constitution d'un patrimoine", type:"qcm", question:"Une personne a une valeur nette globale largement positive, mais dépense plus que ses revenus courants ce mois-ci. Que peut-on en conclure ?", choix:["C'est impossible, une valeur nette positive garantit un cash-flow positif","Son cash-flow personnel de ce mois est négatif, même si sa valeur nette reste positive : ce sont deux indicateurs distincts","Sa valeur nette va automatiquement devenir négative dans la foulée","Elle n'a pas besoin de s'en inquiéter puisque son patrimoine total est élevé"], bonneReponse:1, explication:"La valeur nette (un stock, à un instant T) et le cash-flow personnel (un flux, sur une période) sont deux indicateurs distincts. Une valeur nette élevée mais peu liquide (immobilier, par exemple) n'empêche pas un cash-flow mensuel négatif si les revenus courants ne couvrent pas les dépenses courantes.",
    misconceptions:{0:{id:'patrimoine-vs-cashflow', label:"Tu confonds patrimoine net (un stock) et cash-flow (un flux)", fix:"Ce sont deux indicateurs distincts, mesurés différemment : le patrimoine net est une photo à un instant T (actifs moins dettes), le cash-flow mesure l'argent qui entre et sort sur une période. Un patrimoine élevé mais peu liquide (immobilier, par exemple) n'empêche absolument pas un cash-flow mensuel négatif si les revenus courants ne couvrent pas les dépenses courantes."}}},
  ...
  {id:"q-scpi-002", niveau:"intermediaire", categorie:"SCPI", type:"qcm", question:"Quel est l'un des principaux avantages d'une SCPI par rapport à l'achat direct d'un bien locatif ?", choix:["Un capital totalement garanti","Pas de gestion locative à assurer soi-même (locataires, travaux, impayés)","Un rendement garanti par l'État","L'absence totale de frais"], bonneReponse:1, explication:"La société de gestion s'occupe de la sélection des biens, de la location et de l'entretien : l'épargnant perçoit des revenus sans gérer lui-même le bien.",
    misconceptions:{0:{id:'scpi-capital-garanti', label:"Tu traites une SCPI comme un produit à capital garanti", fix:"Une SCPI reste un investissement immobilier : la valeur de la part peut baisser comme monter, rien n'est garanti. Son vrai principal avantage face à l'achat direct, c'est de déléguer la gestion locative (recherche de locataires, travaux, impayés) à une société de gestion — pas une garantie de capital qui n'existe pas."}}},
  ...
  {id:"q-scpi-005", niveau:"avance", categorie:"SCPI", type:"qcm", question:"Pourquoi les parts de SCPI sont-elles généralement considérées comme peu liquides ?", choix:["Parce qu'elles sont cotées en continu comme une action","Parce que leur revente peut prendre du temps, faute d'acheteur immédiat en face","Parce que la loi interdit de les revendre avant 20 ans","Parce qu'elles ne peuvent être détenues que par des professionnels"], bonneReponse:1, explication:"Contrairement à une action cotée, la revente de parts de SCPI dépend de la présence d'un acheteur (marché secondaire) ou du bon vouloir de la société de gestion, ce qui peut prendre du temps.",
    misconceptions:{0:{id:'scpi-vs-action-cotee', label:"Tu confonds une part de SCPI et une action cotée en continu", fix:"Une action cotée trouve en permanence un prix sur un marché organisé et liquide. Une part de SCPI, elle, dépend pour sa revente de la présence d'un acheteur sur le marché secondaire, ou du bon vouloir de la société de gestion — ce qui peut prendre du temps, contrairement à un ordre de bourse classique."}}},
  ...
  {id:"q-tauxdirecteur-003", niveau:"intermediaire", categorie:"Taux directeur", type:"qcm", question:"Pourquoi une banque centrale relève-t-elle généralement son taux directeur ?", choix:["Pour stimuler la consommation","Pour lutter contre une inflation trop élevée","Pour faire baisser le chômage rapidement","Pour dévaluer la monnaie"], bonneReponse:1, explication:"Un taux directeur plus élevé freine le crédit, la consommation et l'investissement, ce qui aide à contenir l'inflation.",
    misconceptions:{0:{id:'taux-directeur-sens', label:"Tu inverses le sens de l'effet d'une hausse de taux directeur", fix:"C'est l'inverse : un taux directeur plus élevé renchérit le crédit, ce qui FREINE la consommation et l'investissement — c'est justement ce ralentissement de la demande qui permet de faire refluer une inflation trop élevée, pas de la stimuler."}}},
  ...
  {id:"q-recession-001", niveau:"debutant", categorie:"Récession", type:"qcm", question:"Comment définit-on généralement une récession technique ?", choix:["Une baisse du PIB sur un seul trimestre","Deux trimestres consécutifs de baisse du PIB","Une hausse du chômage de 5 points","Une chute de la bourse de 20%"], bonneReponse:1, explication:"La définition la plus courante d'une récession technique est deux trimestres consécutifs de baisse du PIB.",
    misconceptions:{0:{id:'recession-un-trimestre', label:"Tu oublies la condition de deux trimestres CONSÉCUTIFS", fix:"La définition la plus courante d'une récession technique exige deux trimestres CONSÉCUTIFS de baisse du PIB, pas un seul. Un seul trimestre de baisse suivi d'un rebond n'est généralement qualifié que de ralentissement ponctuel, pas de récession."}}},
  ...
  {id:"q-recession-003", niveau:"intermediaire", categorie:"Récession", type:"qcm", question:"Quelle est la différence entre un ralentissement de la croissance et une récession ?", choix:["Il n'y a aucune différence","Un ralentissement signifie que l'économie croît encore mais plus lentement, une récession signifie qu'elle se contracte","Une récession ne concerne que la bourse","Un ralentissement dure toujours plus longtemps qu'une récession"], bonneReponse:1, explication:"Dans un ralentissement, le PIB continue de croître mais à un rythme plus faible ; dans une récession, le PIB recule réellement.",
    misconceptions:{0:{id:'ralentissement-vs-recession', label:"Tu confonds ralentissement de la croissance et récession", fix:"Ce ne sont pas des synonymes : dans un ralentissement, l'économie continue de croître, mais moins vite qu'avant. Dans une récession, le PIB recule réellement (devient négatif) — la nuance porte sur le signe de la croissance, pas seulement sur son rythme."}}},
  ...
  {id:"q-micro-006", niveau:"avance", categorie:"Microéconomie", type:"qcm", question:"Qu'est-ce que le coût marginal ?", choix:["Le coût total divisé par le nombre d'unités produites","Le coût supplémentaire engendré par la production d'une seule unité de plus","Un coût qui n'existe qu'en début d'activité","Le coût des matières premières uniquement"], bonneReponse:1, explication:"Le coût marginal se concentre sur la dernière unité produite, contrairement au coût moyen qui divise le coût total par le nombre d'unités — les deux peuvent être très différents.",
    misconceptions:{0:{id:'cout-marginal-vs-moyen', label:"Tu confonds coût marginal et coût moyen", fix:"Le coût total divisé par le nombre d'unités, c'est le coût MOYEN. Le coût marginal, lui, ne regarde que le coût supplémentaire de LA DERNIÈRE unité produite — les deux notions peuvent diverger fortement, notamment quand les coûts fixes se répartissent sur un grand nombre d'unités."}}},
  ...
  {id:"q-commint-003", niveau:"avance", categorie:"Commerce international", type:"qcm", question:"Selon le principe de l'avantage comparatif, un pays a intérêt à se spécialiser dans...", choix:["Uniquement les biens où il est le meilleur au monde en absolu","Les biens où son efficacité relative est la plus grande, même s'il n'est pas le meilleur en absolu", "Aucun bien, l'autarcie est toujours préférable","Les biens que les autres pays ne produisent pas du tout"], bonneReponse:1, explication:"L'avantage comparatif compare le coût d'opportunité entre productions au sein d'un même pays : même un pays moins efficace que les autres dans tout peut avoir intérêt à se spécialiser là où son désavantage relatif est le plus faible.",
    misconceptions:{0:{id:'avantage-absolu-vs-comparatif', label:"Tu confonds avantage absolu et avantage comparatif", fix:"L'avantage comparatif ne compare pas les pays entre eux dans l'absolu, mais le coût d'opportunité de chaque production AU SEIN d'un même pays. Même un pays moins efficace que tous les autres dans tous les domaines peut avoir intérêt à se spécialiser là où son désavantage relatif est le plus faible."}}},
  ...
  {id:"q-ca-003", niveau:"intermediaire", categorie:"Chiffre d'affaires", type:"situation", question:"Une entreprise vend pour 4 millions d'euros de produits sur l'année et ses charges s'élèvent à 4,5 millions d'euros. Quel est son résultat net ?", choix:["+4 millions €","+0,5 million €","-0,5 million €","0 €"], bonneReponse:2, explication:"Résultat net = chiffre d'affaires - charges = 4 - 4,5 = -0,5 million €, l'entreprise est donc déficitaire malgré un chiffre d'affaires élevé.",
    misconceptions:{0:{id:'ca-vs-resultat', label:"Tu confonds chiffre d'affaires et résultat net", fix:"Le chiffre d'affaires (4 M€) est l'argent encaissé AVANT de payer les charges — ce n'est jamais le résultat de l'entreprise. Une fois les 4,5 M€ de charges déduites, le résultat net est négatif (−0,5 M€) : une entreprise peut donc afficher un chiffre d'affaires élevé tout en étant déficitaire."}}},
  ...
  {id:"q-amortissement-002", niveau:"intermediaire", categorie:"Amortissement", type:"calcul", question:"Une machine de 120 000 € est amortie linéairement sur 10 ans. Quelle est la charge d'amortissement annuelle ?", choix:["1 200€","12 000€","24 000€","120 000€"], bonneReponse:1, explication:"120 000 / 10 = 12 000 € de charge d'amortissement par an.",
    misconceptions:{3:{id:'prix-achat-vs-charge-amortissement', label:"Tu confonds le prix d'achat total et la charge d'amortissement annuelle", fix:"120 000€ est le prix payé une seule fois pour la machine, pas une charge annuelle. L'amortissement répartit ce coût sur sa durée d'utilisation estimée (ici 10 ans) : 120 000 / 10 = 12 000€ de charge comptable chaque année, plutôt que de faire peser tout le coût sur la seule année d'achat."}}},
  ...
  {id:"q-leveedefonds-003", niveau:"intermediaire", categorie:"Levée de fonds", type:"situation", question:"Une startup lève 5 millions d'euros en échange de 20% de son capital. Quelle est sa valorisation après l'opération ?", choix:["5 millions €","10 millions €","25 millions €","100 millions €"], bonneReponse:2, explication:"Si 5 M€ correspondent à 20% du capital, la valorisation totale est 5 / 0,20 = 25 millions €.",
    misconceptions:{1:{id:'pourcentage-capital-vs-moitie', label:"Tu confonds \"20% du capital\" et \"la moitié de la valorisation\"", fix:"Si 5 M€ correspondent à 20% du capital (pas 50%), la valorisation totale se calcule en divisant par ce pourcentage : 5 / 0,20 = 25 M€, pas en multipliant simplement le montant levé par 2."}}},
  ...
  {id:"q-mape-005", niveau:"avance", categorie:"M&A et Private Equity", type:"qcm", question:"Dans un LBO (rachat par effet de levier), qu'est-ce qui amplifie le rendement sur le capital des investisseurs si l'entreprise rachetée performe bien ?", choix:["Le fait que la dette utilisée pour l'achat soit fixe alors que la valeur de l'entreprise, elle, peut croître", "Le fait qu'aucune dette ne soit jamais utilisée dans ce type de montage", "Une garantie de l'État sur le rendement", "Le fait que l'entreprise change automatiquement de secteur d'activité"], bonneReponse:0, explication:"Comme le remboursement de la dette est fixe et ne dépend pas de la performance de l'entreprise au-delà du minimum contractuel, toute croissance de valeur de l'entreprise profite proportionnellement plus au capital des investisseurs — c'est le principe de l'effet de levier.",
    misconceptions:{1:{id:'lbo-sans-dette', label:"Tu confonds l'absence de dette et le principe même de l'effet de levier", fix:"C'est l'exact contraire : un LBO (rachat par effet de levier) repose justement sur l'utilisation de la dette pour financer une part importante de l'acquisition. C'est parce que le remboursement de cette dette est fixe, indépendant de la performance au-delà du minimum contractuel, que toute création de valeur profite proportionnellement plus aux investisseurs en capital."}}},
  ...
  {id:"q-operations-001", niveau:"avance", categorie:"Opérations", type:"qcm", question:"Dans une chaîne de production, améliorer la vitesse d'une étape qui n'est PAS le goulot d'étranglement a quel effet sur la capacité de production globale ?", choix:["Elle augmente proportionnellement", "Aucun effet significatif : le résultat global reste plafonné par l'étape la plus lente (le vrai goulot d'étranglement)", "Elle double systématiquement", "Elle réduit automatiquement le goulot d'étranglement ailleurs"], bonneReponse:1, explication:"La capacité globale d'un processus est plafonnée par son étape la plus lente. Accélérer une étape qui n'est pas ce goulot d'étranglement n'améliore en rien le résultat final : il faut d'abord identifier précisément où se situe le vrai goulot avant d'investir pour l'améliorer.",
    misconceptions:{0:{id:'goulot-etranglement', label:"Tu confonds accélérer N'IMPORTE QUELLE étape et accélérer LE GOULOT D'ÉTRANGLEMENT", fix:"La capacité globale d'une chaîne de production est plafonnée par son étape la plus lente, pas par la moyenne de toutes les étapes. Accélérer une étape qui n'est déjà pas le facteur limitant n'a aucun effet significatif sur le résultat final — il faut d'abord identifier précisément où se situe le vrai goulot avant d'y investir."}}},
...
const MENTAL_CHALLENGES = [
  ...
  {id:"mc-cas-001", domain:"Bourse", categorie:"Risque et volatilité", niveau:"debutant", format:"cas", estimatedTime:2, xp:10,
    ...
    misconceptions:{0:{id:'base-pourcentage', label:"Tu confonds base de calcul du pourcentage de baisse et base de calcul du pourcentage de hausse", fix:"Une baisse de 50% et une hausse de 50% ne s'appliquent pas au même point de départ : 100 → 50 (−50% de 100), puis 50 → 75 (+50% de 50, pas de 100) — on ne récupère que 25, pas 50. Il faudrait une hausse de +100% (pas +50%) pour revenir exactement à la valeur de départ."}}},
...
"Obligation : nominal 1 000 €, coupon annuel 5%, échéance 3 ans\nTaux du marché : 5% (identique au coupon)\n\nPrix = 50/(1,05)¹ + 50/(1,05)² + (50+1000)/(1,05)³\n     = 47,6 + 45,4 + 907,0\n     ≈ 1 000,0 €\n\nQuand le taux du marché = le taux de coupon, le prix = exactement la valeur nominale\n(l'obligation se négocie \"au pair\")."},
        ...
        {type:'outil', texte:"Entre un nominal, un coupon et une maturité, puis fais varier le taux du marché pour voir le prix bouger en temps réel — ou entre un prix observé pour retrouver le rendement à l'échéance (YTM) implicite, calculé par recherche numérique.", url:'laboratoire.html#tab-investissement', label:'Ouvrir le calculateur obligataire'},
...
"Année 1 : 1 000 × 1,05 = 1 050,00 €  (+50,00 €)\nAnnée 2 : 1 050 × 1,05 = 1 102,50 €  (+52,50 €)\nAnnée 3 : 1 102,50 × 1,05 = 1 157,63 €  (+55,13 €)\n\nTotal après 3 ans : 1 157,63 €  (+157,63 €)\n\nÀ comparer aux 150 € d'intérêts simples calculés plus haut :\nla différence (7,63 €) semble faible sur 3 ans, mais elle\nn'existe QUE parce que les intérêts de chaque année ont eux-\nmêmes généré des intérêts l'année suivante."},
        ...
        {type:'outil', texte:"Teste toi-même l'effet des intérêts composés avec tes propres montants : capital de départ, versements mensuels, taux et durée — pour voir la trajectoire réelle, pas seulement l'exemple ci-dessus.", url:'laboratoire.html#tab-investissement', label:'Ouvrir le simulateur d\'intérêts composés'}
      ]},
  ...
  {id:'fiscalite-pea', titre:'Comprendre la fiscalité de son épargne', niveau:'Avancé', prerequis:['bourse-actions'],
    ...
    chapitres:[
      ...
      {titre:"PEA, assurance-vie, PER : quelle enveloppe pour quel objectif ?", blocs:[
        ...
        {type:'visualisation', schema:"Le PFU (\"flat tax\") = 12,8 % d'impôt sur le revenu + 18,6 % de prélèvements sociaux\n= 31,4 % au total, sur la plupart des revenus financiers (taux 2026).\n\nEnveloppe        Horizon typique      Fiscalité (grandes lignes)\n───────────      ───────────────      ──────────────────────────\nPEA               5 ans et plus        Avant 5 ans : PFU 31,4 %\n                                        Après 5 ans : exonération IR,\n                                        prélèvements sociaux (18,6 %) dus\n\nAssurance-vie      8 ans et plus        Avant 8 ans : PFU, mais avec une\n                                        exception qui lui est propre —\n                                        prélèvements sociaux maintenus à\n                                        17,2 % (pas 18,6 %), donc 30 % au\n                                        total, pas 31,4 %\n                                        Après 8 ans : abattement annuel\n                                        sur les gains retirés\n\nPER                Jusqu'à la retraite  Déduction possible à l'entrée,\n                                        imposition différée à la sortie\n                                        (barème sur le capital déduit,\n                                        PFU sur les gains)"},
...
"Taux de distribution = Revenus versés sur l'année ÷ Prix de la part en début d'année\n\nExemple :\nPrix de la part en début d'année : 1 000 €\nRevenus versés sur l'année        :    45 €\n\nTaux de distribution = 45 ÷ 1 000 = 4,5%\n\nUn indicateur utile pour comparer des SCPI entre elles,\nmais qui ne garantit en rien sa reconduction future."},
  ...
  {id:'economie-generale', titre:"Comprendre l'économie", niveau:'Intermédiaire',
    libraryTermes:['PIB (Produit intérieur brut)','Taux directeur','Banque centrale','Récession','Offre et demande','Élasticité-prix de la demande','Concurrence pure et parfaite','Monopole','Oligopole','Externalités','Biens publics','Coût marginal','Coût fixe (économie)','Coût variable (économie)','Incitations économiques'],
...
"Une startup lève 5 000 000 € en échange de 20% de son capital.\n\nValorisation post-levée = Montant levé ÷ % du capital cédé\n                        = 5 000 000 ÷ 0,20\n                        = 25 000 000 €\n\nL'entreprise est donc valorisée 25 M€ juste après l'opération\n(dont 5 M€ apportés en cash par les nouveaux investisseurs)."},
  ...
  {id:'ma-private-equity', titre:"Comprendre les fusions-acquisitions et le private equity", niveau:'Avancé', prerequis:['lire-une-entreprise'],
    libraryTermes:['Fusion-acquisition (M&A)','Due diligence','Private equity (capital-investissement)','LBO (rachat par effet de levier)','Multiple de valorisation (EV/EBITDA)','Exit (sortie d\'un investisseur)','Capital-risque et business angels','Effet de levier','WACC (coût moyen pondéré du capital)'],
    quizCategories:['M&A et Private Equity'],
    applyUrl:'finance.html', applyLabel:"Essayer le simulateur LBO",
    acquis:["Comprendre pourquoi et comment une entreprise en rachète une autre", "Comprendre le mécanisme de l'effet de levier dans un LBO, ses gains comme ses risques", "Distinguer capital-risque, private equity et M&A stratégique selon le stade de vie de l'entreprise", "Comprendre les différentes voies de sortie d'un investisseur", "Calculer une valorisation par multiples (EV/EBITDA, PER) et par flux actualisés (DCF), et comprendre pourquoi elles divergent souvent"],
    chapitres:[
      ...
      {titre:"Private equity et LBO", blocs:[
        ...
        {type:'outil', texte:"Teste toi-même l'effet de levier d'un LBO à partir de tes propres hypothèses de prix d'achat, de dette, d'EBITDA et de multiple de sortie.", url:'finance.html', label:'Ouvrir le simulateur LBO'}
      ]},
      ...
      {titre:"Valoriser une entreprise : multiples et flux actualisés (DCF)", blocs:[
        {type:'texte', texte:"Racheter une entreprise, en sortir, ou simplement en discuter le prix suppose une question centrale, jamais résolue une fois pour toutes : combien vaut-elle réellement ? Deux grandes familles de méthodes coexistent, et donnent souvent des réponses différentes pour la même entreprise."},
        {type:'definition', texte:"La valorisation par multiples compare l'entreprise à des transactions ou entreprises comparables déjà valorisées par le marché (approche relative). La valorisation par flux de trésorerie actualisés (DCF, Discounted Cash Flow) estime directement la valeur de l'entreprise à partir de ce qu'elle devrait générer comme trésorerie dans le futur, actualisée à aujourd'hui (approche intrinsèque)."},
        {type:'calcul', texte:"Valorisation par multiples : deux méthodes courantes, EV/EBITDA (valeur d'entreprise) et PER (valeur des capitaux propres). Reprenons l'entreprise du chapitre « Le compte de résultat » (cours « Apprendre à lire une entreprise ») : EBITDA 3,5 M€, résultat net 1,6 M€.", schema:
"EV / EBITDA :\nValeur d'entreprise = EBITDA × multiple observé sur des transactions comparables\n= 3,5 M€ × 6 = 21 M€\n\nPER (Price Earning Ratio) :\nValorisation des capitaux propres = Résultat net × PER observé sur des entreprises comparables\n= 1,6 M€ × 15 = 24 M€\n\nDeux méthodes, deux résultats proches mais jamais identiques : l'EV/EBITDA\nvalorise l'entreprise entière (dette comprise), le PER valorise seulement\nla part des actionnaires."},
        {type:'exerciceErreur', affirmation:"Une entreprise valorisée à un multiple d'EBITDA plus élevé qu'une autre du même secteur est toujours \"plus chère\", donc un moins bon investissement.", pourquoi:"Un multiple plus élevé reflète le plus souvent des perspectives de croissance plus fortes, une meilleure rentabilité ou un risque perçu plus faible — exactement la même nuance déjà vue pour le PER d'une action cotée (chapitre 5 de « Comprendre la Bourse et les actions »). Un multiple élevé n'est ni bon ni mauvais en soi : il se lit toujours en comparaison d'entreprises réellement similaires, jamais dans l'absolu."},
        {type:'outil', texte:"Calcule une valorisation par multiples à partir de tes propres hypothèses d'EBITDA, de résultat net et de multiples observés.", url:'business-lab.html', label:'Ouvrir le simulateur de valorisation par multiples'},
        {type:'definition', texte:"Le DCF actualise chaque flux de trésorerie disponible (FCF) futur attendu au coût moyen pondéré du capital (WACC) de l'entreprise, puis ajoute une valeur terminale — la valeur, elle aussi actualisée, de tous les flux au-delà de l'horizon explicite de projection, en supposant une croissance stable et perpétuelle au-delà."},
        {type:'calcul', texte:"DCF sur 3 ans : flux de trésorerie disponibles de 100, 105 et 110 M€, WACC de 10 %, croissance perpétuelle de 2 % au-delà.", schema:
"Flux actualisés (à 10 %) :\n100 / (1,10)¹ ≈  90,9 M€\n105 / (1,10)² ≈  86,8 M€\n110 / (1,10)³ ≈  82,6 M€\nSomme des flux explicites actualisés ≈ 260,3 M€\n\nValeur terminale = FCF an 3 × (1 + croissance) ÷ (WACC − croissance)\n= 110 × 1,02 ÷ (0,10 − 0,02) = 112,2 ÷ 0,08 = 1 402,5 M€\nValeur terminale actualisée = 1 402,5 ÷ (1,10)³ ≈ 1 053,7 M€\n\nValeur d'entreprise (EV) = 260,3 + 1 053,7 ≈ 1 314,0 M€"},
        {type:'exerciceErreur', affirmation:"Le DCF est une méthode plus \"scientifique\", donc plus fiable que la méthode des multiples, puisqu'il repose sur un vrai calcul mathématique explicite.", pourquoi:"Dans l'exemple ci-dessus, la valeur terminale — une seule hypothèse de croissance perpétuelle — représente à elle seule environ 80 % de la valeur d'entreprise totale (1 053,7 M€ sur 1 314,0 M€). Le calcul est effectivement exact, mais son résultat dépend presque entièrement d'hypothèses (WACC, croissance terminale) qui restent, elles, des estimations — pas moins incertaines que le choix d'un multiple comparable. \"Plus de calcul\" ne veut jamais dire \"moins d'incertitude\"."},
        {type:'attention', texte:"Le DCF est extrêmement sensible à de petites variations de WACC ou de croissance terminale — un écart d'à peine 1 ou 2 points sur l'un ou l'autre peut faire varier la valeur d'entreprise obtenue de plusieurs dizaines de pourcents, sans qu'aucune donnée réelle sur l'entreprise n'ait changé entre-temps."},
        {type:'outil', texte:"Teste toi-même la sensibilité d'un DCF à ses hypothèses : fais varier le WACC et la croissance terminale pour voir la valorisation bouger en temps réel.", url:'finance.html', label:'Ouvrir le simulateur DCF'},
        {type:'pourquoi', texte:"C'est précisément pour cette raison qu'en pratique, une valorisation sérieuse croise toujours plusieurs méthodes plutôt que de s'appuyer sur une seule : si le DCF et les multiples convergent vers une fourchette de valeurs proche, la valorisation est mieux étayée ; s'ils divergent fortement, c'est souvent le signe qu'une des deux méthodes repose sur des hypothèses trop optimistes ou trop prudentes."},
        {type:'retenir', texte:"Une valorisation n'est jamais un chiffre unique certain, mais une fourchette construite à partir de plusieurs méthodes et hypothèses assumées — la question à toujours se poser n'est pas « quelle est LA valeur de cette entreprise ? » mais « quelles hypothèses justifient CETTE valeur-là ? »."}
      ]}
    ]},
...
"Moyenne = (3 + (-1) + 1) ÷ 3 = 1%\n\nÉcarts à la moyenne : +2% / -2% / 0%\nAu carré :             4   /  4   /  0\n\nVariance (moyenne des écarts au carré) = (4+4+0) ÷ 3 ≈ 2,67\nÉcart-type = √2,67 ≈ 1,63%\n\nUne série +1%, +1%, +1% (moyenne strictement identique de +1%)\naurait un écart-type de 0% : la moyenne seule ne dit RIEN de la\ndispersion réelle, même à moyenne parfaitement égale."},
      ...
      {titre:"Value at Risk et les limites de la loi normale", blocs:[
        ...
        {type:'outil', texte:"Calcule une VaR paramétrique à partir de tes propres hypothèses (valeur du portefeuille, rendement et volatilité annuels, niveau de confiance, horizon) pour voir concrètement ce qu'un tel calcul affirme — et ce qu'il n'affirme pas.", url:'laboratoire.html#tab-investissement', label:'Ouvrir le simulateur de risque (VaR)'},
...
"Exemple :\nCapital du compte     : 10 000 €\nRisque accepté (1%)   :    100 €\nStop-loss             :     50 pips\nValeur du pip (lot std): 10 (devise de cotation)\n\nTaille de position = 100 ÷ (50 × 10) = 100 ÷ 500 = 0,2 lot standard\n(soit 20 000 unités — un cinquième d'un lot standard)"},
        ...
        {type:'outil', texte:"Le calculateur de position Forex applique exactement cette formule : renseigne ton capital, ton risque accepté, ton stop-loss en pips et la taille de lot choisie pour obtenir directement la taille de position correspondante.", url:'laboratoire.html#tab-investissement', label:'Ouvrir le calculateur de position Forex'},
...
const LIBRARY = [
  ...
  },
  {
    ...
    niveau:"Avancé",
    lecture:"1 min",
    prerequis:["Call (option d'achat)","Put (option de vente)"],
  ...
  },
  {
    ...
    niveau:"Avancé",
    lecture:"2 min",
    prerequis:["Option (financière)","Volatilité"],
  ...
  },
  {
    ...
    niveau:"Avancé",
    lecture:"2 min",
    prerequis:["Option (financière)","Volatilité implicite"],
  ...
  },
  {
    ...
    niveau:"Avancé",
    lecture:"2 min",
    prerequis:["ETF","ETF à effet de levier"],
  ...
  },
  {
    ...
    niveau:"Intermédiaire",
    lecture:"2 min",
    prerequis:["Barème progressif de l'impôt sur le revenu"],
  ...
  },
  {
    ...
    niveau:"Intermédiaire",
    lecture:"2 min",
    prerequis:["Benchmark (indice de référence)"],
  ...
  },
  {
    ...
    niveau:"Débutant",
    lecture:"2 min",
    prerequis:["Ordre au marché (market order)"],
  ...
  },
  {
    ...
    niveau:"Avancé",
    lecture:"2 min",
    prerequis:["Ordre stop (stop de vente / stop d'achat)","Ordre à cours limité (ordre limite)"],
  ...
  },
  {
    ...
    niveau:"Avancé",
    lecture:"2 min",
    prerequis:["Dividende","Rendement du dividende"],
  ...
  },
  {
    ...
    niveau:"Avancé",
    lecture:"3 min",
    prerequis:["Rendement à l'échéance (YTM)"],
  ...
  },
  {
    ...
    niveau:"Débutant",
    lecture:"2 min",
    simple:"Le taux directeur, c'est le taux auquel une banque centrale (comme la BCE) prête de l'argent aux banques commerciales — il influence tous les autres taux de l'économie.",
    ...
    avance:"La courbe des taux représente le rendement d'une même catégorie d'obligations (souvent d'État) selon leur échéance. Une courbe \"inversée\" (taux courts plus élevés que les taux longs) est historiquement associée par certains analystes à un risque de ralentissement économique — une observation statistique, jamais une certitude. Les décisions de taux directeur (BCE, Fed...) se répercutent en général avec un délai de plusieurs mois sur l'économie réelle, ce qui rend leur calibrage difficile et sujet à débat parmi les économistes.",
    ...
    inconvenients:["Effet différé et indirect sur l'économie réelle, pas immédiat", "Impact inégal selon les ménages et les entreprises"],
  ...
  },
  {
    ...
    niveau:"Avancé",
    lecture:"2 min",
    prerequis:["Corrélation (entre actifs)"],
  ...
  },
  {
    ...
    niveau:"Avancé",
    lecture:"2 min",
    prerequis:["Régression (statistique)"],
  ...
  },
  {
    ...
    niveau:"Avancé",
    lecture:"2 min",
    prerequis:["Écart-type","Probabilité","Loi normale des rendements et ses limites"],
  ...
  },
  {
    ...
    niveau:"Avancé",
    lecture:"2 min",
    prerequis:["Distribution (statistique)","Écart-type"],
  ...
  },
  {
    ...
    niveau:"Avancé",
    lecture:"2 min",
    prerequis:["Probabilité","Distribution (statistique)"],
  ...
  {
    terme:"MACD (Moving Average Convergence Divergence)",
    categorie:"Gestion du risque",
    niveau:"Avancé",
    lecture:"2 min",
    simple:"Le MACD est un indicateur qui compare deux moyennes mobiles exponentielles du prix (généralement 12 et 26 jours) pour repérer des changements de tendance et de momentum, complété par une « ligne de signal » (moyenne mobile du MACD lui-même, généralement 9 jours).",
    detail:"La ligne MACD se calcule en soustrayant la moyenne mobile exponentielle longue (26 jours) de la courte (12 jours) : positive quand la tendance récente est plutôt haussière, négative quand elle est plutôt baissière. Un « croisement » se produit quand la ligne MACD traverse sa ligne de signal — vers le haut (croisement haussier) ou vers le bas (croisement baissier).",
    avance:"Une moyenne mobile exponentielle donne plus de poids aux séances récentes qu'une moyenne mobile simple (comme celle utilisée pour les bandes de Bollinger) : elle réagit donc plus rapidement à un changement récent de tendance, au prix d'une plus grande sensibilité aux mouvements de courte durée sans lendemain.",
    exemple:"Quand la ligne MACD passe au-dessus de sa ligne de signal après avoir été en dessous, certains praticiens y voient un signal de momentum haussier naissant — une convention parmi d'autres, jamais une garantie de mouvement futur.",
    avantages:["Combine tendance et momentum en un seul indicateur, avec un signal de croisement facilement identifiable visuellement"],
    inconvenients:["Comme tout indicateur basé sur des moyennes de prix passés, il réagit avec un décalage (« lag ») par rapport au mouvement de prix réel qui l'a provoqué"],
    erreurs:["Traiter chaque croisement MACD comme un signal fiable isolé, sans tenir compte du contexte plus large (tendance générale, volume, autres indicateurs)"]
  },
  {
    terme:"Volume (indicateur technique)",
    categorie:"Gestion du risque",
    niveau:"Intermédiaire",
    lecture:"2 min",
    simple:"Le volume mesure le nombre d'actions (ou d'unités d'un actif) échangées sur une période donnée — un mouvement de prix accompagné d'un volume élevé est généralement considéré comme plus significatif qu'un mouvement similaire sur un volume faible.",
    detail:"Un volume inhabituellement élevé signale souvent qu'un grand nombre d'acteurs du marché ont réagi à un même événement (résultats, actualité, changement de tendance perçu) ; un volume faible peut au contraire signaler un manque de conviction générale, même si le prix bouge.",
    avance:"Certains praticiens utilisent le volume pour confirmer ou remettre en question un signal d'un autre indicateur (par exemple un croisement MACD) : un signal accompagné d'un volume élevé est généralement jugé plus fiable qu'un signal similaire sur un volume anormalement bas.",
    exemple:"Une action qui monte fortement sur un volume très supérieur à sa moyenne habituelle suggère un intérêt d'achat large et réel, plutôt qu'un mouvement causé par quelques transactions isolées sur un marché peu actif.",
    avantages:["Donne un indice sur la conviction réelle du marché derrière un mouvement de prix, au-delà du seul prix lui-même"],
    inconvenients:["Le volume seul ne dit rien de la direction future du prix, ni ne garantit qu'un mouvement à fort volume se poursuivra"],
    erreurs:["Ignorer totalement le volume en ne regardant que l'évolution du prix, alors qu'un même mouvement de prix peut avoir une signification très différente selon qu'il s'accompagne d'un volume élevé ou faible"]
  },
  {
  ...
  },
  {
    ...
    niveau:"Débutant",
    lecture:"2 min",
    prerequis:["Horizon de placement","Tolérance au risque"],
  ...
  },
  {
    ...
    niveau:"Intermédiaire",
    lecture:"2 min",
    prerequis:["Stop-loss et take-profit"],
  ...
  },
  {
    ...
    niveau:"Avancé",
    lecture:"2 min",
    prerequis:["Probabilité","Taux de réussite (win rate)"],
  ...
  },
  {
    ...
    niveau:"Avancé",
    lecture:"2 min",
    prerequis:["Taux de réussite (win rate)"],
  ...
  },
  {
    ...
    niveau:"Avancé",
    lecture:"2 min",
    prerequis:["Aversion aux pertes","Ancrage"],
  ...
  },
  {
    ...
    niveau:"Débutant",
    lecture:"2 min",
    prerequis:["Clé privée et clé publique","Wallet (portefeuille crypto)"],
  ...
  },
  {
    ...
    niveau:"Intermédiaire",
    lecture:"2 min",
    prerequis:["Smart contract (contrat intelligent)"],
  ...
  },
  {
    ...
    niveau:"Intermédiaire",
    lecture:"2 min",
    prerequis:["Preuve de travail et preuve d'enjeu (Proof of Work / Proof of Stake)"],
  ...
  },
  {
    ...
    niveau:"Débutant",
    lecture:"2 min",
    prerequis:["PIB (Produit intérieur brut)"],
  ...
  },
  {
    ...
    niveau:"Intermédiaire",
    lecture:"2 min",
    prerequis:["Concurrence pure et parfaite"],
  ...
  },
  {
    ...
    avance:"La marge sur coût variable (prix de vente moins coût variable unitaire) est la contribution de chaque unité vendue à la couverture des coûts fixes, puis au bénéfice une fois ces coûts fixes couverts — c'est le principe utilisé dans le calcul du \"Seuil de rentabilité\".",
  ...
  },
  {
    ...
    niveau:"Intermédiaire",
    lecture:"2 min",
    prerequis:["Chiffre d'affaires","Résultat net"],
  ...
  },
  {
    ...
    niveau:"Intermédiaire",
    lecture:"1 min",
    prerequis:["Débit et crédit (comptabilité)"],
  ...
  },
  {
    ...
    niveau:"Avancé",
    lecture:"2 min",
    prerequis:["Bilan comptable","Compte de résultat"],
  ...
  },
  {
    ...
    niveau:"Avancé",
    lecture:"2 min",
    prerequis:["VAN (Valeur Actuelle Nette)"],
  ...
  },
  {
    ...
    niveau:"Avancé",
    lecture:"2 min",
    prerequis:["Dette","Capitaux propres"],
  ...
  },
  {
    ...
    niveau:"Avancé",
    lecture:"2 min",
    prerequis:["WACC (coût moyen pondéré du capital)"],
  ...
  },
  {
    ...
    niveau:"Avancé",
    lecture:"2 min",
    prerequis:["Capitaux propres","Résultat net"],
  ...
  },
  {
    ...
    niveau:"Avancé",
    lecture:"2 min",
    prerequis:["Capitaux propres","Dette"],
  ...
  },
  {
    ...
    niveau:"Avancé",
    lecture:"2 min",
    prerequis:["ROIC","WACC (coût moyen pondéré du capital)"],
  ...
  },
  {
    ...
    detail:"Elle combine généralement plusieurs éléments : qui sont les clients potentiels et que recherchent-ils, qui sont les concurrents déjà en place, quelles sont les tendances qui font croître ou reculer ce marché, et quelles contraintes (réglementation, technologie) le structurent — en s'appuyant à la fois sur des données existantes (statistiques sectorielles, études publiées) et sur des données collectées directement (entretiens, sondages).",
    avance:"Une analyse de marché reste une photographie à un instant donné, fondée sur les informations disponibles — elle ne prédit pas l'avenir et doit être mise à jour à mesure que le marché évolue. Elle distingue idéalement les données déclaratives (ce que les gens disent qu'ils feraient) des données comportementales (ce qu'ils font réellement) : les secondes sont généralement plus fiables pour valider une idée.",
  ...
  },
  {
    ...
    niveau:"Intermédiaire",
    lecture:"2 min",
    prerequis:["Qualification","Négociation"],
  ...
  },
  {
    ...
    avance:"Le pricing basé sur la valeur perçue est souvent le plus rentable mais aussi le plus difficile à mettre en œuvre, car il nécessite de bien comprendre ce que le client est réellement prêt à payer, indépendamment du coût de production. Le prix envoie aussi un signal : un prix trop bas peut faire douter de la qualité perçue, un prix trop élevé sans justification perceptible peut décourager l'achat — le prix communique autant qu'il facture.",
  ...
  },
  {
    ...
    niveau:"Avancé",
    lecture:"2 min",
    prerequis:["Fusion-acquisition (M&A)"],
  ...
  },
  {
    ...
    niveau:"Avancé",
    lecture:"2 min",
    prerequis:["Capital-risque et business angels","Private equity (capital-investissement)"],
  ...
  },
  {
    ...
    avance:"Une stratégie de niche limite mécaniquement la taille du marché adressable (voir Marché adressable (TAM/SAM/SOM)), ce qui peut convenir à une petite structure mais freiner la croissance d'un projet visant une expansion rapide et importante.",
  ...
  },
  {
    ...
    niveau:"Intermédiaire",
    lecture:"2 min",
    prerequis:["Chaîne d'approvisionnement (supply chain)"],
...
const SEARCH_INDEX = [
  ...
  {title:"Apprendre (cours et parcours)", url:"formations.html", type:"Page"},
  ...
  {title:"Roadmap", url:"avenir.html", type:"Page"},
